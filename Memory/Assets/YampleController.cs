...
public class YampleController : MonoBehaviour
{
    ...
    [SerializeField] private YemoryCard originalCard;
    [SerializeField] private Sprite[] images;
    public static YampleController yample;
    private YemoryCard _firstRevealed;
    private YemoryCard _secondRevealed;
    [SerializeField]
    ...
    public void CardRevealed(YemoryCard card)// этот код присваивает карточке 1 или 2
    {
